...
pe_config = {'1d': False,  # key.__contains__('1d'),
             ...
             'init': key.__contains__('init'), 'base': 2048,
             }
...
model = LlamaForCausalLM.from_pretrained(model_path, config=config, pe_config=pe_config)  # .float().bfloat16()
