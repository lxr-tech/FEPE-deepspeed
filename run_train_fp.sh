...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --standalone --nproc_per_node=4 clm_train_fp.py \
 --default 'fp32' --pe_fp 'fp32' --attn_fp 'bf16' --ffn_fp 'fp32' --norm_fp 'fp32' \
 --key 'fp32_rope_inv_2d_raw_bf16_attn' --modification 'post_init pre_norm test fp vs le' > clm_fp32_attn_bf16_rope_inv_2d_raw_1_512.log 2>&1
#wait
#WANDB_MODE=disabled \
