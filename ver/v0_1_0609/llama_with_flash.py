...
def apply_rotary_pos_emb(q, k, cos, sin, position_ids):
    # The first and third dimension of cos and sin are always 1, so we can `squeeze` them.
    cos = cos.squeeze(2).squeeze(0)  # [seq_len, dim]
    sin = sin.squeeze(2).squeeze(0)  # [seq_len, dim]
...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        #     scale = math.e ** ((t - q_len / 2) / 1024)
        #     query_states = query_states / scale[None, :, None, None]
        #     key_states = key_states * scale[None, :, None, None]  #
